...
import com.riuir.calibur.ui.home.search.adapter.RoleSearchAdapter;
 ...
 */
public class SearchRoleFragment extends BaseFragment {

    @BindView(R.id.search_role_fragment_list_view)
    RecyclerView listView;
    @BindView(R.id.search_role_fragment_refresh_layout)
    SwipeRefreshLayout refreshLayout;

    RoleSearchAdapter adapter;
    ...
    protected int getContentViewID() {
        return R.layout.fragment_search_role;
    }
    ...
    private void setListAdapter() {
        adapter = new RoleSearchAdapter(R.layout.user_follow_role_list_item,baseSearchList,getContext());
    ...
    private void setListener() {
        ...
        activity.setSearchRoleStartListener(new DramaSearchActivity.SearchStartListener() {
            @Override
