...
public class SearchBangumiFragment extends BaseFragment {

    @BindView(R.id.search_bangumi_fragment_list_view)
    RecyclerView listView;
    @BindView(R.id.search_bangumi_fragment_refresh_layout)
    ...
    protected int getContentViewID() {
        return R.layout.fragment_search_bangumi;
    }
    ...
    private void setListAdapter() {
        adapter = new DramaSearchAdapter(R.layout.drama_timeline_list_item,baseSearchList,getContext());
    ...
    private void setNet() {
        setPage();
        apiService.getCallSearch(editContent,"bangumi",page)
    ...
    private void setListener() {
        ...
        activity.setSearchBangumiStartListener(new DramaSearchActivity.SearchStartListener() {
            @Override
