...
public class FollowedRoleAdapter extends BaseQuickAdapter<UserFollowedRoleInfo.UserFollowedRoleInfoList,BaseViewHolder> {

    Context context;

    public FollowedRoleAdapter(int layoutResId, @Nullable List<UserFollowedRoleInfo.UserFollowedRoleInfoList> data, Context context) {
        super(layoutResId, data);
        this.context = context;
    }

    public FollowedRoleAdapter(int layoutResId, @Nullable List<UserFollowedRoleInfo.UserFollowedRoleInfoList> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, UserFollowedRoleInfo.UserFollowedRoleInfoList item) {
        ...
        helper.setText(R.id.drama_role_list_item_number,"贡献："+item.getHas_star());
