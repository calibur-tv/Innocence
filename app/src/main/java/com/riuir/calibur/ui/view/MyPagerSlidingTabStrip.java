...
public class MyPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private final MyPagerSlidingTabStrip.PageListener pageListener = new MyPagerSlidingTabStrip.PageListener();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //通过处理tabPadding，设置底部横线与文字宽度一致，并设置边角
        RectF rectF = new RectF(lineLeft + tabPadding, height - indicatorHeight, lineRight - tabPadding, height);
        canvas.drawRoundRect(rectF, mRoundRadius, mRoundRadius, rectPaint);
...
//        canvas.drawRect(lineLeft, height - indicatorHeight, lineRight, height, rectPaint);
    ...
    public void onRestoreInstanceState(Parcelable state) {
        MyPagerSlidingTabStrip.SavedState savedState = (MyPagerSlidingTabStrip.SavedState) state;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        MyPagerSlidingTabStrip.SavedState savedState = new MyPagerSlidingTabStrip.SavedState(superState);
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<MyPagerSlidingTabStrip.SavedState> CREATOR = new Parcelable.Creator<MyPagerSlidingTabStrip.SavedState>() {
            @Override
            public MyPagerSlidingTabStrip.SavedState createFromParcel(Parcel in) {
                return new MyPagerSlidingTabStrip.SavedState(in);
            }

            @Override
            public MyPagerSlidingTabStrip.SavedState[] newArray(int size) {
                return new MyPagerSlidingTabStrip.SavedState[size];
            }
        };
    }
}
