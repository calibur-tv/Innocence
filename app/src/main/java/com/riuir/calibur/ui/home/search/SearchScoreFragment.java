 ...
 */
public class SearchScoreFragment extends BaseFragment {

    @BindView(R.id.search_score_fragment_list_view)
    RecyclerView listView;
    @BindView(R.id.search_score_fragment_refresh_layout)
    SwipeRefreshLayout refreshLayout;

    ScoreSearchAdapter adapter;
    ...
    protected int getContentViewID() {
        return R.layout.fragment_search_score;
    }
    ...
    private void setListAdapter() {
        adapter = new ScoreSearchAdapter(R.layout.main_score_list_item,baseSearchList,getContext());
...
//        isFirstLoad = false;
    ...
    private void setNet() {
        setPage();
        searchCall = apiGet.getCallSearch(editContent,"score",page);
    ...
    private void setListener() {
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()){
                    case R.id.main_score_list_item_user_icon:
                        SearchAnimeInfo.SearchAnimeInfoList info = (SearchAnimeInfo.SearchAnimeInfoList) adapter.getData().get(position);
        ...
        activity.setSearchScoreStartListener(new DramaSearchActivity.SearchStartListener() {
            @Override
