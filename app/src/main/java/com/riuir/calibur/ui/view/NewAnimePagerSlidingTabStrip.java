...
public class NewAnimePagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public NewAnimePagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public NewAnimePagerSlidingTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NewAnimePagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
