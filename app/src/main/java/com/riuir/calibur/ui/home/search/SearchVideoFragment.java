...
import com.riuir.calibur.ui.home.search.adapter.VideoSearchAdapter;
...
public class SearchVideoFragment extends BaseFragment {
    ...
    @BindView(R.id.search_video_fragment_list_view)
    RecyclerView listView;
    @BindView(R.id.search_video_fragment_refresh_layout)
    ...
    private void setListAdapter() {
        adapter = new VideoSearchAdapter(R.layout.drama_video_episodes_list_item,baseSearchList,getContext());
    ...
    private void setNet() {
        setPage();
        searchCall = apiGet.getCallSearch(editContent,"video",page);
    ...
    private void setListener() {
        ...
        activity.setSearchVideoStartListener(new DramaSearchActivity.SearchStartListener() {
            @Override
