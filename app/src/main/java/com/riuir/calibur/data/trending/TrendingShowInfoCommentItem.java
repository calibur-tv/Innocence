...
public class TrendingShowInfoCommentItem {
    private int code;
    private TrendingShowInfoCommentItemData data;
    ...
    public TrendingShowInfoCommentItemData getData() {
        return data;
    }

    public void setData(TrendingShowInfoCommentItemData data) {
        this.data = data;
    }

    @Override
    public String toString() {
        return "TrendingShowInfoCommentItem{" +
                "code=" + code +
                ", data=" + data +
                '}';
    }

    public class TrendingShowInfoCommentItemData{
        private int id;
        ...
        private TrendingChildCommentInfo.TrendingChildCommentInfoData comments;
        ...
        public TrendingChildCommentInfo.TrendingChildCommentInfoData getComments() {
            return comments;
        }

        public void setComments(TrendingChildCommentInfo.TrendingChildCommentInfoData comments) {
