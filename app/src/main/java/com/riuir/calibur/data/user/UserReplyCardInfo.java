...
public class UserReplyCardInfo {
    private int code;
    private UserReplayCardInfoData data;
    ...
    public UserReplayCardInfoData getData() {
        return data;
    }

    public void setData(UserReplayCardInfoData data) {
        this.data = data;
    }

    @Override
    public String toString() {
        return "UserReplyCardInfo{" +
                "code=" + code +
                ", data=" + data +
                '}';
    }

    public class UserReplayCardInfoData{
