...
public class ChooseImageAlbum {
    private int code;
    private List<ChooseImageAlbumData> data;
    ...
    public List<ChooseImageAlbumData> getData() {
        return data;
    }

    public void setData(List<ChooseImageAlbumData> data) {
        this.data = data;
    }

    @Override
    public String toString() {
        return "ChooseImageAlbum{" +
                "code=" + code +
                ", data=" + data +
                '}';
    }

    public class ChooseImageAlbumData{
        private int id;
        private String name;
