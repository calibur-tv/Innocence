...
public class MainTrendingInfo {
    ...
    private int code;
    private MainTrendingInfoData data;
    ...
    public MainTrendingInfoData getData() {
        return data;
    }

    public void setData(MainTrendingInfoData data) {
        this.data = data;
    }

    @Override
    public String toString() {
        return "MainTrendingInfo{" +
                "code=" + code +
                ", data=" + data +
                '}';
    }

    public class MainTrendingInfoData{
