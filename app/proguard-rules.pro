...
#-------------------------3.工具类------------------------
-keep class com.riuir.calibur.assistUtils.**{*;}
-keep class com.riuir.calibur.utils.**{*;}

#-------------------------4.自定义view类------------------------
-keep class com.riuir.calibur.ui.view.**{*;}
-keep class com.riuir.calibur.ui.vidget.**{*;}
-keep class com.riuir.calibur.ui.common.**{*;}
...
-keep class calibur.core.http.models**{*;}
-keep class calibur.core.wigget**{*;}
