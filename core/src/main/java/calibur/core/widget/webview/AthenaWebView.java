package calibur.core.widget.webview;
...
public class AthenaWebView extends WebView {
  ...
  protected static final String[] ALTERNATIVE_BROWSERS = new String[] {
      "org.mozilla.firefox", "com.android.chrome", "com.opera.browser", "org.mozilla.firefox_beta", "com.chrome.beta", "com.opera.browser.beta"
  };
  ...
  public AthenaWebView(Context context) {
    super(context);
    init(context);
  }

  public AthenaWebView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(context);
  }

  public AthenaWebView(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  protected void init(Context context) {
    ...
    webSettings.setAppCachePath(APP_CACHE_DIRNAME);
  ...
  public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
    ...
    // if the download manager app has been disabled on the device
      ...
      openAppSettings(context, AthenaWebView.PACKAGE_NAME_DOWNLOAD_MANAGER);
