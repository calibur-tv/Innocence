 ...
 * description:
 */
public class NoticeTemplateRender implements ITemplateRender {
  ...
  @Override public Template getRenderTemplate() {
    ...
    try {
      InputStream inputStream = FoundationContextHolder.getContext().getAssets().open("temple_notice.mustache");
  ...
  @Override public void checkForUpdate() {
    RetrofitManager.getInstance().getService(APIService.class).checkTemplateUpdate("notice", 1)
